...
export const MOCK_POLLS: PollWithCounts[] = [
  {
    ...
    createdById: "user-1",
    _count: { submission: 234, question: 5 },
  },
  {
    id: "2",
    ...
    updatedAt: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
    createdById: "user-1",
    _count: { submission: 0, question: 8 },
  },
  {
    id: "3",
    ...
    createdById: "user-1",
    _count: { submission: 89, question: 3 },
  },
  {
    id: "4",
    ...
    createdById: "user-1",
    _count: { submission: 156, question: 6 },
  },
  {
    id: "5",
    ...
    updatedAt: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(),
    createdById: "user-1",
    _count: { submission: 42, question: 4 },
  },
]
